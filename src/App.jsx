...
const QUESTIONS = {
  ...
  basement: [
    ...
    { id: "basementRoomCount", label: "How many separate rooms/spaces? (up to 8)", type: "number", unit: "rooms", min: 1, max: 8, step: 1, default: 3, visibleIf: (a) => a.layoutMethod === "Room by room (exact, most accurate)" },
  ...
  flood: [
    ...
    { id: "roomCount", label: "How many rooms/spaces were flooded? (up to 5)", type: "number", unit: "rooms", min: 1, max: 5, step: 1, default: 1, visibleIf: (a) => a.floodLayoutMethod !== "Approximate (I know room count + overall size, not exact rooms)" },
                    ...
                    <tbody>
                      {result.items.filter((it) => !it.hideFromBreakdown).map((it, i) => (
                        <tr key={it.idx} className="border-t align-top" style={{ borderColor: "#E6F0FC" }}>
                          ...
                          <td className="py-3 px-5 text-right font-medium whitespace-nowrap no-print">
                            <input
                              type="number"
                              step="1"
                              ...
                              className="w-24 border rounded-lg px-2 py-1 text-right text-sm focus:outline-none focus:ring-2"
                              style={{ borderColor: "#DCEAFB" }}
                            />
                          </td>
                          <td className="py-3 pl-2 pr-5 text-right whitespace-nowrap print-only">
                            {formatCAD(it.cost)}
                          </td>
                          <td className="py-3 pl-1 pr-4 no-print">
